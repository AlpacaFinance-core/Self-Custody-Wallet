# PepeDollar Self Custody Wallet
...
PepeDollar Wallet is a non-custodial crypto wallet built for traders who demand both ironclad security and execution speed. Your keys never leave your device, and your trades never wait in line. Designed from the ground up for active on-chain traders, PepeDollar combines hardware-grade key management with a high-performance trading engine optimized for sub-second order routing.
...
### 🔐 Security First
- **True self-custody** — Private keys are generated and stored locally; PepeDollar servers never see them
...
1. **Install** PepeDollar on your platform of choice.
2. **Create a wallet** or import an existing one using a seed phrase or hardware device.
3. **Back up your seed phrase** — write it down and store it offline. PepeDollar cannot recover it for you.
...
PepeDollar is built on a modular, security-focused architecture:
...
Security is the foundation of PepeDollar, not an afterthought.
...
PepeDollar is released under the [MIT License](./LICENSE).

## Disclaimer

PepeDollar is non-custodial software. You are solely responsible for the security of your seed phrase and private keys. Lost keys cannot be recovered. Cryptocurrency trading involves substantial risk; never trade more than you can afford to lose. PepeDollar is provided "as is" without warranty of any kind.

## Links

- 🌐 Website: [PepeDollar.io](https://PepeDollar.io)
- 📖 Docs: [docs.PepeDollar.io](https://docs.PepeDollar.io)
- 🐦 Twitter: [@PepeDollar](https://twitter.com/PepeDollar)
- 💬 Discord: [discord.gg/PepeDollar](https://discord.gg/PepeDollar)
- 📧 Contact: hello@PepeDollar.io
